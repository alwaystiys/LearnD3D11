...
class IndexedTriangleRenderer : public Renderer {
public:
	IndexedTriangleRenderer() {
		m_indexBuffer = 0;
	};
	~IndexedTriangleRenderer() {};
...
bool IndexedTriangleRenderer::Init(ID3D11Device* device, HWND hwnd)
{
...
bool IndexedTriangleRenderer::Render(ID3D11DeviceContext* deviceContext)
{
...
void IndexedTriangleRenderer::Shutdown()
{
	if (m_indexBuffer) {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
{
	...
	myRenderer = new IndexedTriangleRenderer;
